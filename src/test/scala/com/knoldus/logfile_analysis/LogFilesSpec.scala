...
class LogFilesSpec extends FlatSpec with BeforeAndAfterAll {
  ...
  "getLogRecord method" should "return list of objects of case class LogRecord" in {
    ...
    val expectedResult = List(LogRecord(new File("./src/main/resources/res/stdout-log5"), 0, 1454, 256), LogRecord(new File("./src/main/resources/res/stdout-log9"), 87, 1259, 272), LogRecord(new File("./src/main/resources/res/stdout-log2"), 0, 1446, 245), LogRecord(new File("./src/main/resources/res/stdout-log7"), 0, 1446, 245), LogRecord(new File("./src/main/resources/res/stdout-log8"), 0, 1446, 245), LogRecord(new File("./src/main/resources/res/stdout-log11"), 89, 1263, 272), LogRecord(new File("./src/main/resources/res/stdout-log1"), 91, 1268, 278), LogRecord(new File("./src/main/resources/res/stdout-log10"), 91, 1268, 278), LogRecord(new File("./src/main/resources/res/stdout-log4"), 0, 1454, 256), LogRecord(new File("./src/main/resources/res/stdout-log12"), 91, 1268, 278))
